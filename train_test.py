...
def train(model, num_epochs, optimizer, loss_function, trainloader, validloader, device, patience=10, path_to_model = 'terry_net', scheduler=None):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        print('Epoch: {}, Training Loss: {:4f}, Training Accuracy: {:.4f}, Validation Loss: {:4f}, Validation Accuracy: {:.4f}'.format(epoch, np.mean(train_loss), num_correct_train/num_examples_train, np.mean(valid_loss), num_correct_valid/num_examples_valid))
